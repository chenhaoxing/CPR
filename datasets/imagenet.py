...
class ImageNet(DatasetBase):
    ...
    def __init__(self, root, num_shots, subsample):
        ...
        self.split_fewshot_dir = os.path.join(self.dataset_dir,
                                              "split_fewshot")
        self.cupl_path = os.path.join('/ossfs/workspace/CPR/gpt3_prompts', 'CuPL_prompts_imagenet.json')
        ...
        print("Finishing read classnames")

        if num_shots >= 1:
            preprocessed = os.path.join(self.split_fewshot_dir,
                                        f"shot_{num_shots}.pkl")
